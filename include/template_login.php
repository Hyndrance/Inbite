...
<html lang="en">
    ...
    <head>
        ...
        <link href="../include/metronic/assets/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
        <link href="../include/metronic/assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="../include/metronic/assets/pages/css/login-4.min.css" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <!-- END THEME LAYOUT STYLES -->
    <link rel="icon" href="../include/images/inbite.ico" type="image/x-icon"> </head>
    <!-- END HEAD -->
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="../include/images/ib-logo.png" alt="" style="width: 150px" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="../include/metronic/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="../include/metronic/assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
        <script src="../include/metronic/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
        <script src="../include/metronic/assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="../include/metronic/assets/global/scripts/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="../include/metronic/assets/pages/scripts/login-4.min.js" type="text/javascript"></script>
